...
export default function StatsCard({stat,}: StatsCardProps) {
  ...
  return (
    <div className="group rounded-3xl border border-zinc-800 bg-zinc-900/60 p-5 backdrop-blur-sm transition-all duration-300 
    hover:border-zinc-700 hover:bg-zinc-900 hover:-translate-y-1 hover:shadow-lg hover:shadow-black/20">
